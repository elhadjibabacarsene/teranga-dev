...
const TimelineSection = ({
  ...
  return (
    <Box {...sectionWrapper}>
      <Container>
        <Box {...sectionHeader}>
          <Text {...sectionSubTitle} content="ÉTAPE DE TRAVAIL" />
          <Heading
            {...sectionTitle}
            content="VOICI LA MANIERE DONT NOUS TRAVAILLONS AVEC NOS CLIENTS"
          />
        </Box>
        <Box {...row}>
          <Box {...col} {...imageArea}>
        ...
        <Box {...buttonWrapper}>
          <Link href="#">
            <a>
              <Button {...button} title="PRENDRE UN RENDEZ-VOUS" />
            </a>
          </Link>
        </Box>
      </Container>
